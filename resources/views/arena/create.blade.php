...
@section('content')
	...
	<div class="page-header page-header-light">
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><span class="font-weight-semibold">Tambah</span> - Arena</h4>
	...
	<div class="content">
		...
		<div class="card">
			...
			<div class="card-body">
				<form id="submit-form" class="form-validate-jquery" action="{{url('/arena')}}" method="post" enctype="multipart/form-data">
					@csrf
					<fieldset class="mb-3">
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Kepemilikan" required autofocus autocomplete="off" value="{{ old('ownership') }}">
							</div>
						</div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Latitude" required autocomplete="off" value="{{ old('latitude') }}">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Longitude" required autocomplete="off" value="{{ old('longitude') }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Fasilitas" required autocomplete="off" cols="30" rows="5">{{ old('facilities') }}</textarea>
							</div>
						</div>
                        <div class="form-group row">
