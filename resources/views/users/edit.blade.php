...
@section('content')
	...
	<div class="content">
		...
		<div class="card">
			...
			<div class="card-body">
				<form id="submit-form" class="form-validate-jquery" action="{{url('users/'.$user->id)}}" method="post" enctype="multipart/form-data">
                    @method('PATCH')
					@csrf
					<fieldset class="mb-3">
						...
						<div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                class="form-control border-blue-700 border-1 @error('password') is-invalid @enderror"
                                placeholder="Password minimal 8 karakter" autocomplete="off">
							</div>
						</div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
								<select name="role_id" id="role_id" class="form-control form-control-select2" data-container-css-class="border-blue-700" data-dropdown-css-class="border-blue-700" required>
                                    @if ($roles->count() < 1)
