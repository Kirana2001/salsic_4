...
@section('content')
	...
	<div class="content">
		...
		<div class="card">
			...
			<div class="card-body">
				<form id="submit-form" class="form-validate-jquery" action="{{url('/users')}}" method="post" enctype="multipart/form-data">
					@csrf
					<fieldset class="mb-3">
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Telepon" autocomplete="off" value="{{ old('phone') }}">
							</div>
						</div>
                        <div class="form-group row">
