					...
					<fieldset class="mb-3">
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="No KK" required autofocus autocomplete="off" value="{{ $wasit->no_kk }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                data-dropdown-css-class="border-blue-700" required>
                                    <option value="pria"  {{$wasit->gender == 'pria' ? 'selected' : ''}}>Pria</option>
                                    <option value="wanita" {{$wasit->gender == 'wanita' ? 'selected' : ''}}>Wanita</option>
                                </select>
							</div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Provinsi" required autocomplete="off" value="{{ $wasit->province }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Kota" required autocomplete="off" value="{{ $wasit->city }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Asal Sekolah" required autocomplete="off" value="{{ $wasit->school }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="email" required autocomplete="off" value="{{ $wasit->email }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="No Rekening" required autocomplete="off" value="{{ $wasit->no_rek }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Nama Bank" required autocomplete="off" value="{{ $wasit->bank }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Lini" required autocomplete="off" value="{{ $wasit->lini }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Klasifikasi" required autocomplete="off" value="{{ $wasit->klasifikasi }}">
							</div>
						</div>
                        <div class="form-group row">
