...
@section('content')
	...
	<div class="page-header page-header-light">
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><span class="font-weight-semibold">Edit</span> - Event</h4>
	...
	<div class="content">
		...
		<div class="card">
			...
			<div class="card-body">
				<form id="submit-form" class="form-validate-jquery" action="{{url('events/'.$event->id)}}" method="post" enctype="multipart/form-data">
                    @method('PATCH')
					@csrf
					<fieldset class="mb-3">
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Nama Event" required autofocus autocomplete="off" value="{{ $event->event_name }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Tanggal Mulai" required autofocus autocomplete="off" value="{{ $event->start_date }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Tanggal Selesai" required autofocus autocomplete="off" value="{{ $event->end_date }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Jam Mulai" required autofocus autocomplete="off" value="{{ $event->start_time }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Jam Selesai" required autofocus autocomplete="off" value="{{ $event->end_time }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Judul" required autofocus autocomplete="off" value="{{ $event->header }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Deskripsi" required autocomplete="off" cols="30" rows="20">{{ $event->description }}</textarea>
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
								<div class="card-img-actions mb-3">
                                    ...
                                    src="{{url($event->image) ??asset('global_assets/images/placeholders/cover.jpg')}}" alt="">
								</div>
					...
					<div class="text-right">
						<a href="{{ url('/events')}}" class="btn btn-light">Kembali <i class="icon-undo"></i></a>
